  ...
  return (
    <div className="bg-[#f3f4f6] min-h-full pb-10">
      <div className="bg-white border-b border-neutral-200 px-4 py-3 flex items-center justify-between">
        <div>
          <h1 className="text-black font-normal uppercase text-xl leading-tight" style={{ fontFamily: "'Roboto Condensed', sans-serif" }}>SHOPPING CART</h1>
          <p className="text-xs text-neutral-500 font-normal" style={{ fontFamily: "'Ubuntu', sans-serif" }}>{selectedCount} of {totalItems} items selected for checkout</p>
        </div>
        <Link to="/shop" className="text-xs font-normal text-black border border-neutral-200 px-3 py-1.5 rounded-lg hover:bg-neutral-50" style={{ fontFamily: "'Ubuntu', sans-serif" }}>Add Items</Link>
      </div>
      ...
      {items.length === 0 ? (
        <div className="p-6 text-center py-20 bg-white m-3 rounded-2xl border border-neutral-200 shadow-xs">
          ...
          <h2 className="text-lg font-normal text-neutral-800" style={{ fontFamily: "'Roboto Condensed', sans-serif" }}>Your cart is empty</h2>
          <p className="text-xs text-neutral-500 mt-1 mb-5 font-normal" style={{ fontFamily: "'Ubuntu', sans-serif" }}>Explore our catalog to add items to your cart.</p>
          <Link to="/shop" className="inline-flex items-center gap-2 bg-black text-white px-5 py-2.5 rounded-xl font-normal text-xs uppercase tracking-wide hover:bg-neutral-800 transition-colors" style={{ fontFamily: "'Ubuntu', sans-serif" }}>Browse Products <ArrowRight size={14} /></Link>
        </div>
      ) : (
        <div className="p-3 space-y-3">
          <div className="bg-white rounded-xl border border-neutral-200/90 px-3.5 py-2.5 shadow-2xs flex items-center justify-between">
            <button type="button" onClick={handleToggleAll} className="flex items-center gap-2 text-xs font-medium text-neutral-800 hover:text-black cursor-pointer select-none" style={{ fontFamily: "'Ubuntu', sans-serif", fontSize: "13px" }}>
