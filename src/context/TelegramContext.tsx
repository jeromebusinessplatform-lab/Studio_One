  ...
  useEffect(() => {
    ...
    const authenticate = async () => {
      ...
      try {
        ...
        if (hydratedAvatar) {
          void fetchWithTimeout("/api/auth/telegram/avatar-sync", { method: "POST", credentials: "same-origin", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ initData }) }, 5000).catch(() => undefined);
        }
      } catch (e: any) {
